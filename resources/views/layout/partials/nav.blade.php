                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('employees') ? 'active' : '' }}"
                                    href="{{ url('employees') }}">All Employees</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('holidays') ? 'active' : '' }}"
                                    href="{{ url('holidays') }}">Holidays</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('leaves') ? 'active' : '' }}" href="{{ url('leaves') }}">Leaves
                                    (Admin) <span class="badge badge-pill bg-primary float-right">1</span></a>
                            </li>

                            <li>
                                <a class="{{ Request::is('leaves-employee') ? 'active' : '' }}"
                                    href="{{ url('leaves-employee') }}">Leaves (employee)</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('leave-settings') ? 'active' : '' }}"
                                    href="{{ url('leave-settings') }}">Leave Settings</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('attendance') ? 'active' : '' }}"
                                    href="{{ url('attendance') }}">Attendance (Admin)</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('attendance-employee') ? 'active' : '' }}"
                                    href="{{ url('attendance-employee') }}">Attendance (Employee)</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('departments') ? 'active' : '' }}"
                                    href="{{ url('departments') }}">Departments</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('designations') ? 'active' : '' }}"
                                    href="{{ url('designations') }}">Designations</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('timesheet') ? 'active' : '' }}"
                                    href="{{ url('timesheet') }}">Timesheet</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('overtime') ? 'active' : '' }}"
                                    href="{{ url('overtime') }}">Overtime</a>
                            </li>
                    ...
                    <!-- <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('estimates') ? 'active' : '' }}"
                                    href="{{ url('estimates') }}">Estimates</a>
                            </li>
                            ...
                            <li>
                                <a class="{{ Request::is('provident-fund') ? 'active' : '' }}"
                                    href="{{ url('provident-fund') }}">Provident Fund</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('taxes') ? 'active' : '' }}"
                                    href="{{ url('taxes') }}">Taxes</a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('salary') ? 'active' : '' }}"
                                    href="{{ url('salary') }}">Employee Salary</a>
                            </li>


                            <li>
                                <a class="{{ Request::is('salary-view') ? 'active' : '' }}"
                                    href="{{ url('salary-view') }}">Payslip</a>
                            </li>

                            <li>
                                <a class="{{ Request::is('payroll-items') ? 'active' : '' }}"
                                    href="{{ url('payroll-items') }}">Payroll Items</a>
                            </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('expense-reports') ? 'active' : '' }}"
                                    href="{{ url('expense-reports') }}">Expense Report</a>
                            </li>


                            <li>
                                <a class="{{ Request::is('invoice-reports') ? 'active' : '' }}"
                                    href="{{ url('invoice-reports') }}"> Invoice Report </a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('performance-indicator') ? 'active' : '' }}"
                                    href="{{ url('performance-indicator') }}"> Performance Indicator </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('performance') ? 'active' : '' }}"
                                    href="{{ url('performance') }}"> Performance Review </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('performance-appraisal') ? 'active' : '' }}"
                                    href="{{ url('performance-appraisal') }}"> Performance Appraisal </a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <!-- <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('goal-type') ? 'active' : '' }}" href="{{ url('goal-type') }}">
                                    Goal Type </a>
                            </li>
                    ...
                    <!-- <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('training') ? 'active' : '' }}" href="{{ url('training') }}">
                                    Training List </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('trainers') ? 'active' : '' }}" href="{{ url('trainers') }}">
                                    Trainers </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('training-type') ? 'active' : '' }}"
                                    href="{{ url('training-type') }}"> Training Type </a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <li class="{{ Request::is('resignation') ? 'active' : '' }}">
                        <a href="{{ url('resignation') }}"><i class="la la-external-link-square"></i>
                            <span>Resignation</span> </a>
                    </li>

                    <li class="{{ Request::is('termination') ? 'active' : '' }}">
                        <a href="{{ url('termination') }}"><i class="la la-external-link-square"></i>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('jobs') ? 'active' : '' }}" href="{{ url('jobs') }}"> Manage
                                    Jobs </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('jobs-applicants') ? 'active' : '' }}"
                                    href="{{ url('jobs-applicants') }}"> Applied Candidates </a>
                            </li>
                        </ul>
                    </li> -->

                    <!-- <li class="{{ Request::is('knowledgebase') ? 'active' : '' }}">
                        <a href="{{ url('knowledgebase') }}"> <i class="la la-question"></i><span>Knowledgebase</span>
                        </a>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('client-profile') ? 'active' : '' }}"
                                    href="{{ url('client-profile') }}"> Client Profile </a>
                            </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('subscriptions') ? 'active' : '' }}"
                                    href="{{ url('subscriptions') }}"> Subscriptions (Admin) </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('subscriptions-company') ? 'active' : '' }}"
                                    href="{{ url('subscriptions-company') }}"> Subscriptions (Company) </a>
                            </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('search') ? 'active' : '' }}" href="{{ url('search') }}">Search
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="{{ Request::is('terms') ? 'active' : '' }}" href="{{ url('terms') }}"> Terms
                                </a>
                            </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('form-basic-inputs') ? 'active' : '' }}"
                                    href="{{ url('form-basic-inputs') }}"> Basic Inputs </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('form-input-groups') ? 'active' : '' }}"
                                    href="{{ url('form-input-groups') }}"> Input Groups </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('form-horizontal') ? 'active' : '' }}"
                                    href="{{ url('form-horizontal') }}"> Horizontal Form </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('form-vertical') ? 'active' : '' }}"
                                    href="{{ url('form-vertical') }}"> Vertical Form </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('form-mask') ? 'active' : '' }}" href="{{ url('form-mask') }}">
                                    Form Mask </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('form-validation') ? 'active' : '' }}"
                                    href="{{ url('form-validation') }}"> Form Validation </a>
                            </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="{{ Request::is('tables-basic') ? 'active' : '' }}"
                                    href="{{ url('tables-basic') }}"> Basic Tables </a>
                            </li>

                            <li>
                                <a class="{{ Request::is('data-tables') ? 'active' : '' }}"
                                    href="{{ url('data-tables') }}"> Data Table </a>
                            </li>
                        </ul>
                    </li> -->
